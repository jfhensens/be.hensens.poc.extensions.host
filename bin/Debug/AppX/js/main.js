                ...
                Promise.all(oAppExtensionList.map(function (oAppExtension) {
                    ...
                    .then(function (aResults) {
                        if (aResults.length > 0) {
                            var oAppExtension = aResults.sort(function (oFirst, oSecond) {
                                // sort descending by priority
                                return oSecond.priority - oFirst.priority;
                            })[0].extension;

                            if (oAppExtension.package.status.verifyIsOK()) {
                                oAppExtension.getPublicFolderAsync()
                                ...
                                oAppExtension.package.verifyContentIntegrityAsync()
                                    .done(function onComplete(bContentIntegrity) {
                                        debugger;
                                    });
                            }
                        }
